  ...
  return (
    <div className='xs:px-[30%] flex flex-col'>
      ...
      <div className='px-4 my-2'>
        ...
        <p className='indent-4 pb-2'>Hello, I am Gelo Coronel, a full-stack web developer based in the Philippines. I am currently a 2nd year BS in Information Technology student.</p>
